  ...
  <div>
    <div class="gva-table-box">
      ...
      <el-table
        ...
        row-key="ID"
      >
        <el-table-column align="left" label="记录ID" min-width="70" prop="" />
        <el-table-column align="left" label="场所编号" min-width="90" prop="pnum" />
        <el-table-column align="left" label="场所名称" min-width="100" prop="pname" />
        <el-table-column align="left" label="所属区县" min-width="80" prop="phone" />
        <el-table-column align="left" label="所属乡镇" min-width="80" prop="email" />
        <el-table-column align="left" label="所属村" min-width="80" prop="" />
        ...
        <el-table-column align="left" label="经度" min-width="80" prop="jd" />
        <el-table-column align="left" label="纬度" min-width="80" prop="wd" />
        <el-table-column align="left" label="负责人姓名" min-width="100" prop="email" />
        <el-table-column align="left" label="负责人电话" min-width="100" prop="email" />
        <el-table-column align="left" label="负责人身份证" min-width="150" prop="email" />
        ...
        <el-table-column align="left" label="行业类型" min-width="120" prop="" />
