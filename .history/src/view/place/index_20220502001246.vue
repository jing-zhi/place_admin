      ...
      <div style="height:60vh;overflow:auto;padding:0 12px;">
        <el-form ref="placeForm" :model="placeInfo" label-width="80px">
          <el-form-item v-if="dialogFlag === 'add'" label="用户名" prop="userName">
            <el-input v-model="placeInfo.userName" />
          </el-form-item>
          <el-form-item v-if="dialogFlag === 'add'" label="密码" prop="password">
            <el-input v-model="placeInfo.password" />
          </el-form-item>
          <el-form-item label="昵称" prop="nickName">
            <el-input v-model="placeInfo.nickName" />
          </el-form-item>
          <el-form-item label="手机号" prop="phone">
            <el-input v-model="placeInfo.phone" />
          </el-form-item>
          ...
          <el-form-item label="用户角色" prop="authorityId">
            <el-cascader
              v-model="placeInfo.authorityIds"
              style="width:100%"
              :options="authOptions"
              :show-all-levels="false"
          ...
          <el-form-item label="头像" label-width="80px">
            ...
            >
              <img
                v-if="placeInfo.headerImg"
                class="header-img-box"
                :src="(placeInfo.headerImg && placeInfo.headerImg.slice(0, 4) !== 'http')?path + '/' +placeInfo.headerImg:placeInfo.headerImg"
              >
