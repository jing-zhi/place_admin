  ...
  <div>
    ...
    >
      <div style="height:60vh;overflow:auto;padding:0 12px;">
        <el-form ref="placeForm" :model="placeInfo" label-width="80px">
          <el-form-item label="场所名称" prop="csmc">
            <el-input v-model="userInfo.csmc" />
          </el-form-item>
          <el-form-item label="手机号" prop="qx">
            <el-input v-model="userInfo.qx" />
          </el-form-item>
          <!-- <el-form-item label="邮箱" prop="sq">
            <el-input v-model="userInfo.email" />
          </el-form-item>
          <el-form-item label="邮箱" prop="jd">
            <el-input v-model="userInfo.email" />
          </el-form-item>
          <el-form-item label="邮箱" prop="xxdz">
            <el-input v-model="userInfo.email" />
          </el-form-item>
          <el-form-item label="邮箱" prop="qyzt">
            <el-input v-model="userInfo.email" />
          </el-form-item>
          <el-form-item label="邮箱" prop="sq">
            <el-input v-model="userInfo.email" />
...
const closeAddDialog = () => {
  ...
  // placeInfo.value.headerImg = ''
  // placeInfo.value.userName = ''
  // placeInfo.value.nickName = ''
  // placeInfo.value.authorityIds = []
  // placeInfo.value.deptId = ''
...
const placeInfo = ref({
   ...
   placeInfo.value.csmc = '110'
  placeInfo.value.qx = '44'
  // userName: '',
  // password: '',
  // nickName: '',
  // headerImg: '',
