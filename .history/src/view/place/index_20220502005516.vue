      ...
      <div style="height:60vh;overflow:auto;padding:0 12px;">
        <el-form ref="placeForm" :model="placeInfo" label-width="80px">
          ...
          <el-form-item label="所属乡镇" prop="sq_name">
            <el-input v-model="placeInfo.email" />
          </el-form-item>
          ...
          <el-form-item label="负责人姓名" prop="sq">
            <el-input v-model="placeInfo.email" />
          </el-form-item>
          <el-form-item label="负责人电话" prop="sq">
            <el-input v-model="placeInfo.email" />
          </el-form-item>
          <el-form-item label="负责人身份证" prop="sq">
            <el-input v-model="placeInfo.email" />
          </el-form-item>
          <el-form-item label="申领单位" prop="sq">
            <el-input v-model="placeInfo.email" />
          </el-form-item>
          <el-form-item label="申领时间" prop="sq">
            <el-input v-model="placeInfo.email" />
          </el-form-item>
          <el-form-item label="行业类型" prop="sq">
            <el-input v-model="placeInfo.email" />
          </el-form-item>
        </el-form>
