  ...
  <div>
    <div class="gva-table-box">
      ...
      <el-table
        ...
        row-key="ID"
      >
        <el-table-column align="left" label="记录ID" min-width="70" prop="ID" />
        <el-table-column align="left" label="场所编号" min-width="150" prop="csbh" />
        <el-table-column align="left" label="场所bingc" min-width="150" prop="nickName" />
