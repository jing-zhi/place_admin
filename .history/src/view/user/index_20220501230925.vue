  ...
  <div>
    <div class="gva-table-box">
      ...
      <el-table
        ...
        row-key="ID"
      >
        <el-table-column align="left" label="id" min-width="70" prop="cd_id" />
        <el-table-column align="left" label="场所编号" min-width="90" prop="csbh" />
        <el-table-column align="left" label="工作人员姓名" min-width="100" prop="csmc" />
        <el-table-column align="left" label="工作人员手机号" min-width="80" prop="Qx" />
        <el-table-column align="left" label="身份证号" min-width="80" prop="Sq" />
        <el-table-column align="left" label="地市" min-width="80" prop="jd" />
        <el-table-column align="left" label="县区" min-width="200" prop="Xxdz"/>
        <el-table-column align="left" label="所在xiang" min-width="80" prop="Qyzt">
