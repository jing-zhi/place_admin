  ...
  <div>
    <div class="gva-table-box">
      ...
      >
        ...
        <el-table-column align="left" label="工作人员姓名" min-width="100" prop="gzryxm" />
        <el-table-column align="left" label="工作人员手机号" min-width="80" prop="gzrysjh" />
        <el-table-column align="left" label="身份证号" min-width="80" prop="gzrysfz" />
        <el-table-column align="left" label="所在地市" min-width="80" prop="gzrds" />
        ...
        <el-table-column align="left" label="隔离点职务" min-width="100" prop="gldgw" />
        <el-table-column align="left" label="隔离点岗位" min-width="100" prop="Fzrdh" />
        <el-table-column align="left" label="入职隔离点日期" min-width="150" prop="Fzrsfz" />
        <el-table-column align="left" label="人员状态" min-width="180" prop="fzrGzdw" />
        <el-table-column align="left" label="调离时间" min-width="180" prop="Slsj" />
        <el-table-column align="left" label="调离隔离点编号" min-width="120" prop="Hylx" />
