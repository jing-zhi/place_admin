    ...
    <div class="gva-table-box">
      <div class="gva-btn-list">
        <el-button class="excel-btn" size="small" type="primary" icon="plus" @click="addPlace">新增</el-button>
         ...
         <el-form :inline="true" :model="searchInfo" style="margin-left:20px">
           <el-form-item>
             <el-input v-model="searchInfo" min-width="80" placeholder="场所" />
           </el-form-item>
      ...
      >
        ...
        <el-table-column align="left" label="入职隔离点日期" min-width="100" prop="rzrq" />
