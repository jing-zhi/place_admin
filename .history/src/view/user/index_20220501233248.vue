  ...
  <div>
    <div class="gva-table-box">
      ...
      >
        ...
        <el-table-column align="left" label="工作人员姓名" min-width="0" prop="gzryxm" />
        ...
        <el-table-column align="left" label="所在县区" min-width="100" prop="gzrqx"/>
        <el-table-column align="left" label="所在乡编码" min-width="100" prop="gzrxz"/>        
        <el-table-column align="left" label="原工作单位" min-width="80" prop="ydw" />
        <el-table-column align="left" label="隔离点职务" min-width="80" prop="gldzw" />
        <el-table-column align="left" label="隔离点岗位" min-width="80" prop="gldgw" />
        <el-table-column align="left" label="入职隔离点日期" min-width="80" prop="rzrq" />
        <el-table-column align="left" label="人员状态" min-width="80" prop="zt" />
        <el-table-column align="left" label="调离时间" min-width="120" prop="sj" />
        <el-table-column align="left" label="调离隔离点编号" min-width="100" prop="dlgldbh" />
