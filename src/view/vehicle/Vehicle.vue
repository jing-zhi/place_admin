<template>
  <div>
    ...
    <el-table :data="tableData" row-key="ID">
      ...
      <el-table-column align="center" label="手机号码" min-width="120" prop="mobile" />
      <el-table-column align="center" label="身份证号码" min-width="230" prop="idNum" />
      <el-table-column align="center" label="车牌号" min-width="120" prop="carNum" />
      <el-table-column align="center" label="场所名称" min-width="120" prop="csmc" />
      <el-table-column align="center" label="预计进入日期" min-width="120" prop="enterDate" />
