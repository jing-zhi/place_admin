<template>
  <div>
    <div>
      ...
      <div class="gva-table-box" style="margin-bottom: 10px">
        ...
        <el-button size="small" type="primary" @click="exportData"
          ><span class="iconfont icon-shangchuan"></span> 导出</el-button
        >
      </div>
    </div>
    <el-table :data="tableData" row-key="ID">
      ...
      <el-table-column label="操作" min-width="260" fixed="right" v-if="renew">
        <template #default="scope">
          <el-popover
            trigger="click"
...
const deletePlaceFun = (v) => {
  ...
  ElMessageBox.confirm("确认删除？", "提示", {
    ...
    let res = await singleDelete({ id: v.cd_id });
